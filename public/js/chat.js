  const conversations = [
            ...
            {
                id: "chat_02",
                name: "Seni Graphy, Bekasi",
                avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&h=100",
                status: "Active 1h ago",
                preview: "Halo kak, selamat pagi",
                dateLabel: "Oct 12, 2025",
                messages: [
                    { sender: 'user', text: "Min, pricelist wisuda berapa?" },
                    { sender: 'vendor', text: "Halo kak, selamat pagi. Cek IG kami ya." }
                ]
            },
            {
                id: "chat_03",
                name: "Photobooth Gyaru, Bekasi",
                avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&h=100",
                status: "Active 5m ago",
                preview: "Baik kak, terima kasih kembali :)",
                dateLabel: "Oct 10, 2025",
                messages: [
                    { sender: 'vendor', text: "Foto sudah dikirim ya kak." },
                    { sender: 'user', text: "Oke min makasih." },
                    { sender: 'vendor', text: "Baik kak, terima kasih kembali :)" }
                ]
            }
        ];
